NOME_DO_CANDIDATO = 'Marco Aurélio Menezes'
EMAIL_DO_CANDIDATO = 'tetissu@gmail.com'
...
as_edicoes = request_journals('2021-01-20', '2021-02-21')

# for a in range(0, len(as_edicoes['diaries'])):
#     print(as_edicoes['diaries'][a]['arquivo'])
#     print(as_edicoes['diaries'][a]['edicao'])
#     print(f'nº{a}\n\n')
    # print(a)
print(as_edicoes)


# print(as_edicoes['diaries'][0]['data'])



# organizando = []
#
# for edtion in as_edicoes:
#     print(edtion)
#     organizando.append(edtion)


#print(organizando)

# print(as_edicoes['diaries'][0]['edicao'])

# print(request_journals('2021-01-20', '2022-01-25'))